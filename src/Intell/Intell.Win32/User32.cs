...
public static partial class User32 {
    ...
    [DllImport("user32")] public static extern int ShowWindow(IntPtr hwnd, int nCmdShow);
    ...
    [DllImport("user32")] public static extern bool SetWindowPos(IntPtr hWnd, IntPtr hWndInsertAfter, int X, int Y, int cx, int cy, int uFlags);
    ...
    [DllImport("user32")] public static extern IntPtr WindowFromPoint(Point point);
